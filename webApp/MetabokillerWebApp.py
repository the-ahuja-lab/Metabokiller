...
def predict_():
    ...
    mord_apop_train = pd.read_csv("models/apoptosis_train_mordred.csv", low_memory=False)
    ...
    mord_prol_train = pd.read_csv("models/proliferation_train_mordred.csv", low_memory=False)
